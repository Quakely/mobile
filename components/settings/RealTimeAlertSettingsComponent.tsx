...
export const RealTimeAlertSettingsComponent = () => {
            ...
            <Portal>
                ...
                >
                    <BottomSheetView className={"w-full flex items-center justify-center"}>
                        ...
                        <View className={"w-[90%] flex flex-col"}>
                            <View className={"w-full flex flex-row items-center justify-between"}>
                                <View className={"flex flex-col"}>
                                    <Text className={"font-Gilroy-Semi-Bold text-xl"}>Alarm</Text>
                                    <Text className={"w-[40%] font-Gilroy-Regular text-base color-gray-400 text-justify"}>Activate an alarm when a quake is detected in real time by the network of smartphones</Text>
                                </View>
